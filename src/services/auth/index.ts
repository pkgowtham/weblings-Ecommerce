...
export const adminLoginReducer = (
  ...
  switch (action.type) {
    ...
    case "USER_ADMIN_GETLIST_API_FAILURE":
    ...
    case "USER_ADMIN_UPDATE_API_CLEAR":
      ...
      case "USER_ADMIN_DESTROY_API_FAILURE":
      ...
      case "USER_ADMIN_DESTROY_API_CLEAR":
