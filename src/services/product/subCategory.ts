...
export const productSubCategoryReducer = (
  ...
  switch (action.type) {
    ...
    case "PRODUCT_SUB_CATEGORY_GETLIST_API_FAILURE":
    ...
    case "PRODUCT_SUB_CATEGORY_UPDATE_API_CLEAR":
      ...
      case "PRODUCT_SUB_CATEGORY_DESTROY_API_FAILURE":
      ...
      case "PRODUCT_SUB_CATEGORY_DESTROY_API_CLEAR":
