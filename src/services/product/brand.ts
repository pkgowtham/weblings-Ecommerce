...
export const productBrandReducer = (
  ...
  switch (action.type) {
    ...
    case "PRODUCT_BRAND_GETLIST_API_FAILURE":
    ...
    case "PRODUCT_BRAND_UPDATE_API_CLEAR":
      ...
      case "PRODUCT_BRAND_DESTROY_API_FAILURE":
      ...
      case "PRODUCT_BRAND_DESTROY_API_CLEAR":
