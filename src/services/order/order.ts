...
export const orderReducer = (
  ...
  switch (action.type) {
    ...
    case "ORDER_GETLIST_API_FAILURE":
    ...
    case "ORDER_UPDATE_API_CLEAR":
      ...
      case "ORDER_DESTROY_API_FAILURE":
