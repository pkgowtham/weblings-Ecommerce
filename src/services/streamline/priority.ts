...
export const streamlinePriorityReducer = (
  ...
  switch (action.type) {
    ...
    case "STREAMLINE_PRIORITY_GETLIST_API_FAILURE":
    ...
    case "STREAMLINE_PRIORITY_UPDATE_API_CLEAR":
      ...
      case "STREAMLINE_PRIORITY_DESTROY_API_FAILURE":
      ...
      case "STREAMLINE_PRIORITY_DESTROY_API_CLEAR":
