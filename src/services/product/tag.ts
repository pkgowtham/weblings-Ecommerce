...
export const productTagReducer = (
  ...
  switch (action.type) {
    ...
    case "PRODUCT_TAG_GETLIST_API_FAILURE":
    ...
    case "PRODUCT_TAG_UPDATE_API_CLEAR":
      ...
      case "PRODUCT_TAG_DESTROY_API_FAILURE":
      ...
      case "PRODUCT_TAG_DESTROY_API_CLEAR":
