...
export const productRatingReducer = (
  ...
  switch (action.type) {
    ...
    case "PRODUCT_RATING_GETLIST_API_FAILURE":
    ...
    case "PRODUCT_RATING_UPDATE_API_CLEAR":
      ...
      case "PRODUCT_RATING_DESTROY_API_FAILURE":
      ...
      case "PRODUCT_RATING_DESTROY_API_CLEAR":
