...
export const productColorReducer = (
  ...
  switch (action.type) {
    ...
    case "COLOR_GETLIST_API_FAILURE":
    ...
    case "COLOR_UPDATE_API_CLEAR":
      ...
      case "COLOR_DESTROY_API_FAILURE":
