...
export const couriorReducer = (
  ...
  switch (action.type) {
    ...
    case "COURIOR_GETLIST_API_FAILURE":
    ...
    case "COURIOR_UPDATE_API_CLEAR":
      ...
      case "COURIOR_DESTROY_API_FAILURE":
      ...
      case "COURIOR_DESTROY_API_CLEAR":
