...
export const commentsReducer = (
  ...
  switch (action.type) {
    ...
    case "PRODUCT_COMMENT_GETLIST_API_FAILURE":
    ...
    case "PRODUCT_COMMENT_UPDATE_API_CLEAR":
      ...
      case "PRODUCT_COMMENT_DESTROY_API_FAILURE":
      ...
      case "PRODUCT_COMMENT_DESTROY_API_CLEAR":
        return {...state, isLoadingDestroy: false, isSuccessDestroy:false, isErrorDestroy:false, dataDestroy:null, errorDestroy:null,};

        case "PRODUCT_COMMENT_ALL_DESTROY_API_LOADING":
          return { ...state, isLoadingAllDestroy: true,isSuccessAllDestroy:false,isErrorAllDestroy:false, dataAllDestroy:null, errorAllDestroy: null};
        case "PRODUCT_COMMENT_ALL_DESTROY_API_SUCCESS":
          return { ...state, isLoadingAllDestroy: false,isSuccessAllDestroy:true,isErrorAllDestroy:false,dataAllDestroy: action.payload, errorAllDestroy: null };
        case "PRODUCT_COMMENT_ALL_DESTROY_API_FAILURE":
          return { ...state, isLoadingAllDestroy: false,isSuccessAllDestroy:false,isErrorAllDestroy:true,dataAllDestroy:null, errorAllDestroy: action.error };
        case "PRODUCT_COMMENT_ALL_DESTROY_API_CLEAR":
          return {...state, isLoadingAllDestroy: false, isSuccessAllDestroy:false, isErrorAllDestroy:false, dataAllDestroy:null, errorAllDestroy:null,};
