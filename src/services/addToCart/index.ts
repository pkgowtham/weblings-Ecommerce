...
export const productAddToCartReducer = (
  ...
  switch (action.type) {
    ...
    case "PRODUCT_ADD_TO_CART_GETLIST_API_FAILURE":
    ...
    case "PRODUCT_ADD_TO_CART_UPDATE_API_CLEAR":
      ...
      case "PRODUCT_ADD_TO_CART_DESTROY_API_FAILURE":
      ...
      case "PRODUCT_ADD_TO_CART_DESTROY_API_CLEAR":
