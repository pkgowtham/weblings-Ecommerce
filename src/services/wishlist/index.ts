...
export const productWishlistReducer = (
  ...
  switch (action.type) {
    ...
    case "PRODUCT_WHISHLIST_GETLIST_API_FAILURE":
    ...
    case "PRODUCT_WHISHLIST_UPDATE_API_CLEAR":
      ...
      case "PRODUCT_WHISHLIST_DESTROY_API_FAILURE":
      ...
      case "PRODUCT_WHISHLIST_DESTROY_API_CLEAR":
